...
import BetterVet from "../assets/betterVet.png";
import ConstantContact from "../assets/cc.png";
import LogMeIn from "../assets/logmein.png";
import WFF from "../assets/wff.png";
...
const features = [
  {
    ...
    description:
      "Expert in leading and mentoring teams, driving performance, and managing diverse roles effectively.",
    icon: UserGroupIcon,
  },
  {
  ...
  },
  {
    ...
    description:
      "Specialized in maintaining high standards of quality and ensuring regulatory compliance.",
  ...
  },
  {
    ...
    description:
      "Skilled in strategic planning and analysis to enhance team efficiency and operational effectiveness.",
    icon: ChartBarIcon,
  },
];
    ...
    <div className="bg-white">
      <main>
            ...
            <div className="mx-auto max-w-6xl justify-center py-32 sm:py-48 lg:py-12">
              ...
              <div className="text-center">
                <div className="bg-gray-900 rounded-xl w-full p-12">
                  ...
                  <h1 className="text-6xl font-bold tracking-tight text-gray-200 m:text-9xl">
                    Perry Bailes
                  </h1>
                  <p className="mt-6 w-3/4 mx-auto text-lg leading-8 text-center text-gray-200">
                    Experienced professional with a passion for delivering
                    exceptional results. Skilled in leading teams, managing
                    projects, and solving complex problems. Dedicated to
                    continuous improvement and achieving excellence in all
                    endeavors.
                  </p>
                </div>
              </div>
            ...
            <div className="mx-auto flex flex-grid max-w-lg grid-cols-4 justify-center items-center gap-x-12 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-24 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              <div className="flex justify-center items-center">
                <img
                  ...
                  src={WFF}
                  className="bg-white rounded-md p-2 max-h-16 w-auto object-contain"
                />
              </div>
              <div className="flex justify-center items-center">
                <img
        ...
        <div className="mt-32 sm:mt-12">
          ...
          <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-14 md:mt-12 lg:px-8">
              ...
              <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                <figure className="relative isolate pt-6 sm:pt-12">
                  ...
                  <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                    <p>
                      My goals are to continue to grow my industry knowledge and
                      leadership skills. To sow the seeds of innovation, to
                      nurture new attitudes. I strive to make each day better
                      than the last and make my passions profitable. I don't
                      mind the role of student, but I have a knack for being a
                      teacher and mentor. I want to cultivate strong effective
                      relationships and to build winning teams.
                    </p>
                  </blockquote>
          ...
          <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-20 md:mt-32 lg:px-8">
            <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
      ...
      {/* Footer */}
      <footer aria-labelledby="footer-heading" className="mt-24 bg-gray-900">
        <h2 id="footer-heading" className="sr-only">
          Footer
        </h2>
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-12 lg:px-8 lg:py-6">
          <div className="flex flex-col">
            <p className="text-white font-bold">Contact:</p>
          </div>
          <SocialIcon
            url="https://www.linkedin.com/in/perrybailes/"
            target="_blank"
